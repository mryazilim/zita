...
<head>
        ...
        <meta name="Description" content="Zita - Firma Yönetim Sistemi">
        <meta name="Author" content="Zita Firma Yönetim Sistemi">
        <meta name="keywords" content="firma yönetimi, ziyaretçi takibi, araç takibi, dijital dönüşüm, firma paneli, yönetim sistemi, zita, admin panel, dashboard">
        
        <!-- TITLE -->
		<title> Zita - Firma Yönetim Sistemi </title>
        ...
        <!-- MAIN JS -->
        <script src="varliklar/js/main.js"></script>

        
        <!-- NODE WAVES CSS -->
        <link href="varliklar/libs/node-waves/waves.min.css" rel="stylesheet"> 

        <!-- SIMPLEBAR CSS -->
        <link rel="stylesheet" href="varliklar/libs/simplebar/simplebar.min.css">

        <!-- COLOR PICKER CSS -->
        <link rel="stylesheet" href="varliklar/libs/flatpickr/flatpickr.min.css">
        <link rel="stylesheet" href="varliklar/libs/%40simonwep/pickr/themes/nano.min.css">

        <!-- CHOICES CSS -->
        <link rel="stylesheet" href="varliklar/libs/choices.js/public/varliklar/styles/choices.min.css">

        <!-- CHOICES JS -->
        <script src="varliklar/libs/choices.js/public/varliklar/scripts/choices.min.js"></script>
        
        <!-- JSVECTOR MAPS CSS -->
        <link rel="stylesheet" href="varliklar/libs/jsvectormap/css/jsvectormap.min.css">
	...
	<body>
        ...
        <!-- LOADER -->
		<div id="loader">
			<img src="varliklar/images/media/loader.svg" alt="">
		</div>
		<!-- END LOADER -->
                ...
                <div class="main-header-container container-fluid">
                        ...
                        <div class="header-element">
                            <div class="horizontal-logo">
                                <a href="index.html" class="header-logo">
                                    ...
                                    <img src="varliklar/images/brand-logos/toggle-logo.png" alt="logo" class="toggle-logo">
                                    <img src="varliklar/images/brand-logos/desktop-dark.png" alt="logo" class="desktop-dark">
                                    <img src="varliklar/images/brand-logos/toggle-dark.png" alt="logo" class="toggle-dark">
                                </a>
                            </div>
                        </div>
                        <!-- End::header-element -->
                                ...
                                <div id="headersearch" class="header-search">
                                    ...
                                    <div class="py-3 border-top px-0">
                                        <div class="text-center">
                                            <a href="javascript:void(0)" class="text-primary text-decoration-underline fs-15">Tümünü Gör</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="header-content-right">
                        ...
                        <div class="header-element country-selector">
                            ...
                            <ul class="main-header-dropdown dropdown-menu border-0" data-popper-placement="none">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <i class="bx bx-flag fs-14 text-muted"></i>
                                        </span>
                                        Türkçe
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <img src="varliklar/images/flags/spain_flag.jpg" alt="img" >
                                        </span>
                                        İspanyolca
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <img src="varliklar/images/flags/french_flag.jpg" alt="img" >
                                        </span>
                                        Fransızca
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <img src="varliklar/images/flags/germany_flag.jpg" alt="img" >
                                        </span>
                                        Almanca
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <img src="varliklar/images/flags/italy_flag.jpg" alt="img" >
                                        </span>
                                        İtalyanca
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="javascript:void(0);">
                                        <span class="avatar avatar-xs lh-1 me-2">
                                            <img src="varliklar/images/flags/russia_flag.jpg" alt="img" >
                                        </span>
                                        Rusça
                                    </a>
                                </li>
                            ...
                            <div class="main-header-dropdown dropdown-menu  border-0 dropdown-menu-end" data-popper-placement="none">
                                <div class="p-3">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <p class="mb-0 fs-17 fw-semibold">Bildirimler</p>
                                        <span class="badge bg-secondary-transparent" id="notifiation-data">5 Okunmamış</span>
                                    </div>
                                </div>
                                ...
                                <ul class="list-unstyled mb-0" id="header-notification-scroll">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span class="avatar avatar-md bg-secondary-transparent rounded-2">
                                                    <img src="varliklar/images/faces/2.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-grow-1 d-flex  justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="notifications.html">Ayşe Yılmaz</a></p>
                                                    <span class="fs-12 text-muted fw-normal">Yeni şablon başlangıcı için tebrikler</span>
                                                </div>
                                                <div class="min-w-fit-content ms-2 text-end">
                                                    ...
                                                    <p class="mb-0 text-muted fs-11">2 dk önce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 d-flex  justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="notifications.html">Sipariş Verildi <span class="text-warning">ID: #1116773</span></a></p>
                                                    <span class="fs-12 text-muted fw-normal header-notification-text">Sipariş Başarıyla Verildi</span>
                                                </div>
                                                <div class="min-w-fit-content ms-2 text-end">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-muted me-1 dropdown-item-close1"><i class="ti ti-x fs-14"></i></a>
                                                    <p class="mb-0 text-muted fs-11">5 dk önce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            <div class="pe-2">
                                                <span class="avatar avatar-md bg-secondary-transparent rounded-2">
                                                    <img src="varliklar/images/faces/8.jpg" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-grow-1 d-flex  justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="notifications.html">Mehmet Demir</a></p>
                                                    <span class="fs-12 text-muted fw-normal">yeni program yayın tarihi eklendi</span>
                                                </div>
                                                <div class="min-w-fit-content ms-2 text-end">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-muted me-1 dropdown-item-close1"><i class="ti ti-x fs-14"></i></a>
                                                    <p class="mb-0 text-muted fs-11">10 dk önce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 d-flex  justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="notifications.html">Siparişiniz Kargoya Verildi</a></p>
                                                    <span class="fs-12 text-muted fw-normal header-notification-text">Sipariş No: 123456 Teslimat Adresinize Gönderildi</span>
                                                </div>
                                                <div class="min-w-fit-content ms-2 text-end">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-muted me-1 dropdown-item-close1"><i class="ti ti-x fs-14"></i></a>
                                                    <p class="mb-0 text-muted fs-11">12 dk önce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="dropdown-item">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-grow-1 d-flex  justify-content-between">
                                                <div>
                                                    <p class="mb-0 fw-semibold"><a href="notifications.html">Hesap Doğrulandı</a></p>
                                                    <span class="fs-12 text-muted fw-normal  header-notification-text">Hesabınız Başarıyla Doğrulandı</span>
                                                </div>
                                                <div class="min-w-fit-content ms-2 text-end">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="min-w-fit-content text-muted me-1 dropdown-item-close1"><i class="ti ti-x fs-14"></i></a>
                                                    <p class="mb-0 text-muted fs-11">20 dk önce</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="p-3 empty-header-item1 border-top">
                                    <div class="d-grid">
                                        <a href="notifications.html" class="btn btn-primary">Tümünü Gör</a>
                                    </div>
                                </div>
                                <div class="p-5 empty-item1 d-none">
                                    <div class="text-center">
                                        ...
                                        <h6 class="fw-semibold mt-3">Yeni Bildirim Yok</h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="offcanvas-header border-bottom">
                            <h5 id="appsLabel" class="mb-0 fs-18">İlgili Uygulamalar</h5>
                                ...
                                <div class="col-6">
                                        <a href="full-calendar.html">
                                            <div class="text-center p-3 related-app border">
                                                ...
                                                <span class="d-block fs-13 text-muted fw-semibold">Takvim</span>
                                            </div>
                                        </a>
                                </div>
                                <div class="col-6">
                                        <a href="mail.html">
                                            <div class="text-center p-3 related-app border">
                                                ...
                                                <span class="d-block fs-13 text-muted fw-semibold">E-posta</span>
                                            </div>
                                        </a>
                                </div>
                                <div class="col-6">
                                    <a href="profile.html">
                                            <div class="text-center p-3 related-app border">
                                                ...
                                                <span class="d-block fs-13 text-muted fw-semibold">Profil</span>
                                            </div>
                                        </a>
                                </div>
                                <div class="col-6">
                                    <a href="chat.html">
                                            <div class="text-center p-3 related-app border">
                                                ...
                                                <span class="d-block fs-13 text-muted fw-semibold">Sohbet</span>
                                            </div>
                                        </a>
                                </div>
                                <div class="col-6">
                                    <a href="contacts.html">
                                            <div class="text-center p-3 related-app border">
                                                ...
                                                <span class="d-block fs-13 text-muted fw-semibold">Kişiler</span>
                                            </div>
                                        </a>
                                </div>
                                <div class="col-6">
                                    <a href="mail-settings.html">
                                            <div class="text-center p-3 related-app border">
                                                ...
                                                <span class="d-block fs-13 text-muted fw-semibold">Ayarlar</span>
                                            </div>
                                        </a>
                                </div>
                            </div>
                    ...
                    <!-- End::header-element -->
                        ...
                        <!-- Start::header-element -->
                        <div class="header-element mainuserProfil">
                            <!-- Start::header-link|dropdown-toggle -->
                            <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfil" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                <div class="d-flex align-items-center">
                                    <div class="d-sm-flex wd-100p">
                                        <div class="avatar avatar-sm"><img alt="avatar" class="rounded-circle" src="varliklar/images/faces/1.jpg"></div>
                ...
                <div class="main-sidebar" id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide__category"><span class="category-name">Ana</span></li>
                            <!-- End::slide__category -->
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Kontrol Paneli<span class="badge bg-warning-transparent ms-2 d-inline-block">3</span></span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                        <a href="javascript:void(0)">Kontrol Paneli</a>
                                    </li>
                                    <li class="slide">
                                        <a href="index.html" class="side-menu__item">Ana Panel</a>
                                    </li>
                                    <li class="slide">
                                        <a href="dashboard-ziyaretci.html" class="side-menu__item">Ziyaretçi Takibi</a>
                                    </li>
                                    <li class="slide">
                                        <a href="dashboard-arac.html" class="side-menu__item">Araç Takibi</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <!-- Start::slide__category -->
                            <li class="slide__category"><span class="category-name">Genel</span></li>
                            <!-- End::slide__category -->
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Firma Yönetimi</span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                        <a href="javascript:void(0)">Firma Yönetimi</a>
                                    </li>
                                    <li class="slide">
                                        <a href="firma-bilgileri.html" class="side-menu__item">Firma Bilgileri</a>
                                    </li>
                                    <li class="slide">
                                        <a href="kullanicilar.html" class="side-menu__item">Kullanıcılar</a>
                                    </li>
                                    <li class="slide">
                                        <a href="yetkilendirme.html" class="side-menu__item">Yetkilendirme</a>
                                    </li>
                                    <li class="slide">
                                        <a href="ayarlar.html" class="side-menu__item">Ayarlar</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                            ...
                            <!-- Start::slide__category -->
                            <li class="slide__category"><span class="category-name">Sayfalar</span></li>
                            <!-- End::slide__category -->
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Ziyaretçi Takibi</span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                        <a href="javascript:void(0)">Ziyaretçi Takibi</a>
                                    </li>
                                    <li class="slide">
                                        <a href="ziyaretci-kayit.html" class="side-menu__item">Ziyaretçi Kayıt</a>
                                    </li>
                                    <li class="slide">
                                        <a href="ziyaretci-listesi.html" class="side-menu__item">Ziyaretçi Listesi</a>
                                    </li>
                                    <li class="slide">
                                        <a href="ziyaretci-rapor.html" class="side-menu__item">Ziyaretçi Raporu</a>
                                    </li>
                                    <li class="slide">
                                        <a href="ziyaretci-ayarlar.html" class="side-menu__item">Ziyaretçi Ayarları</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item">
                                    ...
                                    <span class="side-menu__label">Araç Takibi</span>
                                    <i class="fe fe-chevron-right side-menu__angle"></i>
                                </a>
                                <ul class="slide-menu child1">
                                    <li class="slide side-menu__label1">
                                        <a href="javascript:void(0)">Araç Takibi</a>
                                    </li>
                                    <li class="slide">
                                        <a href="arac-kayit.html" class="side-menu__item">Araç Kayıt</a>
                                    </li>
                                    <li class="slide">
                                        <a href="arac-listesi.html" class="side-menu__item">Araç Listesi</a>
                                    </li>
                                    <li class="slide">
                                        <a href="arac-konum.html" class="side-menu__item">Araç Konumu</a>
                                    </li>
                                    <li class="slide">
                                        <a href="arac-rapor.html" class="side-menu__item">Araç Raporu</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- End::slide -->
                                                    ...
                                                    <tbody class="top-selling">
                                                            ...
                                                            <td  class=" ps-4">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-md p-2 bg-light avatar-rounded">
                                                                        <img src="varliklar/images/flags/canada_flag.jpg" class="rounded-circle" alt="">
                                                                    </span>
                                                                    <div class="ms-2">
                                                        ...
                                                        <tr>
                                                            <td  class=" ps-4">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-md p-2 bg-light avatar-rounded">
                                                                        <img src="varliklar/images/flags/germany_flag.jpg" class="rounded-circle" alt="">
                                                                    </span>
                                                                    <div class="ms-2">
                                                        ...
                                                        <tr>
                                                            <td class=" ps-4">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-md p-2 bg-light avatar-rounded">
                                                                        <img src="varliklar/images/flags/mexico_flag.jpg" class="rounded-circle" alt="">
                                                                    </span>
                                                                    <div class="ms-2">
                                                        ...
                                                        <tr>
                                                            <td class=" ps-4">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-md p-2 bg-light avatar-rounded">
                                                                        <img src="varliklar/images/flags/russia_flag.jpg" class="rounded-circle" alt="">
                                                                    </span>
                                                                    <div class="ms-2">
                                                        ...
                                                        <tr>
                                                            <td class=" ps-4 border-bottom-0">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="avatar avatar-md p-2 bg-light avatar-rounded">
                                                                        <img src="varliklar/images/flags/us_flag.jpg" class="rounded-circle" alt="">
                                                                    </span>
                                                                    <div class="ms-2">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class=" ps-4">
                                                                        <div class="d-flex align-items-center">
                                                                        <div class="avatar avatar-sm me-2">
                                                                            <img src="varliklar/images/ecommerce/jpg/3.jpg" alt="avatar" class="rounded-1">
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td class=" ps-4">
                                                                        <div class="d-flex align-items-center">
                                                                        <div class="avatar avatar-sm me-2">
                                                                            <img src="varliklar/images/ecommerce/jpg/4.jpg" alt="avatar" class="rounded-1">
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td class=" ps-4">
                                                                        <div class="d-flex align-items-center">
                                                                        <div class="avatar avatar-sm me-2">
                                                                            <img src="varliklar/images/ecommerce/jpg/1.jpg" alt="avatar" class="rounded-1">
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <td class=" ps-4">
                                                                        <div class="d-flex align-items-center">
                                                                        <div class="avatar avatar-sm me-2">
                                                                            <img src="varliklar/images/ecommerce/jpg/2.jpg" alt="avatar" class="rounded-1">
                                                                        </div>
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <div>
                                                                        <p class="mb-0 fs-13 text-muted">
                                                                            <i class="fe fe-arrow-up-right me-1 d-inline-block text-success brround"></i>93.0%
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-fill">
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <div>
                                                                        <p class="mb-0 fs-13 text-muted">
                                                                            <i class="fe fe-arrow-up-right me-1 d-inline-block text-success brround"></i>97.0%
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="progress progress-xs">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-fill">
                                                                <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <div>
                                                                        <p class="mb-0 fs-13 text-muted">
                                                                            <i class="fe fe-arrow-up-right me-1 d-inline-block text-success brround"></i>80.0%
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="progress progress-xs">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-md me-2 avatar-rounded lh-1">
                                                                <img src="varliklar/images/faces/1.jpg" alt="avatar">
                                                            </div>
                                                            <div class="lh-1">
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-md me-2 avatar-rounded lh-1">
                                                                <img src="varliklar/images/faces/2.jpg" alt="avatar">
                                                            </div>
                                                            <div class="lh-1">
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-md me-2 avatar-rounded lh-1">
                                                                <img src="varliklar/images/faces/3.jpg" alt="avatar">
                                                            </div>
                                                            <div class="lh-1">
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar avatar-md me-2 avatar-rounded lh-1">
                                                                <img src="varliklar/images/faces/4.jpg" alt="avatar">
                                                            </div>
                                                        <div class="lh-1">
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md me-2 avatar-rounded lh-1">
                                                            <img src="varliklar/images/faces/5.jpg" alt="avatar">
                                                        </div>
                                                            <div class="lh-1">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-block">
                            <div class="text-center">
                                <a href="javascript:void(0)" class="text-primary text-decoration-underline fs-15">Tümünü Gör results</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="offcanvas-body position-relative">
                    <ul class="nav nav-tabs tab-style-1 d-sm-flex d-block" role="tablist">
                        ...
                        <li class="nav-item">
                            ...
                            class="bx bx-message-square-dots me-1 fs-16 align-middle"></i>Sohbet</button>
                        </li>
                    </ul>
                            ...
                            <ul class="ps-0 vertical-scroll">
                                <li class="item">
                                    <div class="rounded-2 p-3 border mb-2">
                                        <div class="d-flex">
                                            <a href="profile.html"><img src="varliklar/images/faces/16.jpg" alt="img"
                                ...
                                <li class="item">
                                    <div class="rounded-2 p-3 border mb-2">
                                        <div class="d-flex">
                                            <a href="profile.html"><img src="varliklar/images/faces/6.jpg" alt="img"
                                                    class="avatar avatar-md rounded-2 me-3"></a>
                                            <div class="me-3">
                                                <a href="profile.html">
                                ...
                                <li class="item">
                                    <div class="rounded-2 p-3 border mb-2">
                                        <div class="d-flex">
                                            <a href="profile.html"><img src="varliklar/images/faces/9.jpg" alt="img"
                                                    class="avatar avatar-md rounded-2 me-3"></a>
                                            <div class="me-3">
                                                <a href="profile.html">
                        ...
                        <div class="tab-pane" id="accepted-1" role="tabpanel">
                            <ul class="activity-list">
                                <li class="d-flex mt-4">
                                    <div>
                                        <i class="activity-icon">
                                            <a href="profile.html"><img src="varliklar/images/faces/14.jpg" alt="img"
                                ...
                                <li class="d-flex mt-4">
                                    <div>
                                        <i class="activity-icon">
                                            <a href="profile.html"><img src="varliklar/images/faces/11.jpg" alt="img"
                                                    class="avatar avatar-xs rounded-2 me-3"></a>
                                        </i>
                                        <a href="profile.html">
                                ...
                                <li class="d-flex mt-4">
                                    <div>
                                        ...
                                        <div class="activity-images mt-3">
                                            <a href="gallery.html"><img src="varliklar/images/media/media-34.jpg" alt="thumb1"></a>
                                            <a href="gallery.html"><img src="varliklar/images/media/media-35.jpg" alt="thumb1"></a>
                                            <a href="gallery.html"><img src="varliklar/images/media/media-36.jpg" alt="thumb1"></a>
                                        </div>
                                    </div>
                                </li>
                                <li class="d-flex mt-4">
        ...
        <!-- POPPER JS -->
        <script src="varliklar/libs/%40popperjs/core/umd/popper.min.js"></script>

        <!-- BOOTSTRAP JS -->
        <script src="varliklar/libs/bootstrap/js/bootstrap.bundle.min.js"></script>

        <!-- DATE & TIME PICKER JS -->
        <script src="varliklar/libs/flatpickr/flatpickr.min.js"></script>
        <script src="varliklar/js/date%26time_pickers.js"></script>

        <!-- NODE WAVES JS -->
        <script src="varliklar/libs/node-waves/waves.min.js"></script>

        <!-- SIMPLEBAR JS -->
        <script src="varliklar/libs/simplebar/simplebar.min.js"></script>
        <script src="varliklar/js/simplebar.js"></script>

        <!-- COLOR PICKER JS -->
        <script src="varliklar/libs/%40simonwep/pickr/pickr.es5.min.js"></script>

        <!-- DEFAULTMENU JS -->
        <script src="varliklar/js/defaultmenu.js"></script>
                
        <!-- JSVECTOR MAPS JS -->
        <script src="varliklar/libs/jsvectormap/js/jsvectormap.min.js"></script>
        <script src="varliklar/libs/jsvectormap/maps/world-merc.js"></script>

        <!-- CHARTJS CHART JS -->
        <script src="varliklar/libs/chart.js/chart.min.js"></script>

        <!-- APEX CHARTS JS -->
        <script src="varliklar/libs/apexcharts/apexcharts.min.js"></script>

        <!-- CRM-DASHBOARD JS -->
        <script src="varliklar/js/sales-dashboard.js"></script>


        <!-- STICKY JS -->
		<script src="varliklar/js/sticky.js"></script>

        <!-- CUSTOM JS -->
        <script src="varliklar/js/custom.js"></script>

        <!-- CUSTOM-SWITCHER JS -->
        <script src="varliklar/js/custom-switcher.js"></script>
