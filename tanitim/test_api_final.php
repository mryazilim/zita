<?php
/**
 * Zita Projesi - Final API Test
 * 
 * API'yi doğru şekilde test etmek için script
 * 
 * @author Zita Projesi
 * @version v25.1.0.0
 * @date 2025-01-13
...
echo "🔐 Zita Final API Test Scripti\n\n";

// Test verileri
$testData = [
    'vknTc' => '1234567892',
    'vergiDairesi' => 'Test Vergi Dairesi 3',
    'firmaAdi' => 'Test Firma 3 A.Ş.',
    'unvan' => 'Test Firma 3 Anonim Şirketi',
    'telefon' => '05551234569',
    'email' => 'test3@firma.com',
    'adres' => 'Test Adres 3, Test Mahallesi, Test Sokak No:3',
    'il_id' => '1',
    'ilce_id' => '1',
    'isimSoyisim' => 'Test Kullanıcı 3',
    'sifre' => 'test123',
    'sifreTekrar' => 'test123',
    'sektor_id' => '1'
];
